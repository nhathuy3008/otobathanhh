...
//     // Gửi tin nhắn kèm nút "✅ Chấp nhận"
//     await axios.post(`https://api.telegram.org/bot${process.env.TELEGRAM_BOT_TOKEN}/sendMessage`, {
//         chat_id: process.env.TELEGRAM_CHAT_ID,
//         text: `📩 *Yêu cầu đặt lịch mới:*\n👤 ${contact.fullName}\n📅 ${contact.date}\n🕘 ${contact.timeSlot}`,
//         parse_mode: 'Markdown',
//         reply_markup: {
//             inline_keyboard: [[
...
//         for (const imageUrl of contact.images) {
//             await axios.post(`https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/sendPhoto`, {
//                 chat_id: TELEGRAM_CHAT_ID,
//                 photo: imageUrl,
//                 caption: `Ảnh từ ${contact.fullName}`
//             });
//         }
//     }
// };
...
`;
    ...
    // Gửi tin nhắn kèm nút "✅ Chấp nhận" và "❌ Từ chối"
    await axios.post(`https://api.telegram.org/bot${process.env.TELEGRAM_BOT_TOKEN}/sendMessage`, {
        chat_id: process.env.TELEGRAM_CHAT_ID,
        text: `📩 *Yêu cầu đặt lịch mới:*\n👤 ${contact.fullName}\n📅 ${contact.date}\n🕘 ${contact.timeSlot}`,
        parse_mode: 'Markdown',
        reply_markup: {
            inline_keyboard: [
                [
                    { text: '✅ Chấp nhận', callback_data: `accept_${contact._id}` },
                    { text: '❌ Từ chối', callback_data: `reject_${contact._id}` }  // Nút từ chối
                ]
            ]
        }
    });
...
const createContact = async (req, res) => {
    try {
        ...
        // ✅ Gửi Telegram sau khi lưu thành công
        await sendTelegramMessage(newContact);
